...
NightFlow é um aplicativo mobile de organização pessoal, focado em gerenciamento de metas e eventos, desenvolvido com React Native (Expo) e backend em Node.js com banco de dados MySQL.

O projeto foi criado com o objetivo de ajudar o usuário a organizar sua rotina, acompanhar metas pessoais e visualizar eventos de forma simples e intuitiva.
...
* Centralizar metas e compromissos em um único app
* Praticar integração entre app mobile, backend e banco de dados
